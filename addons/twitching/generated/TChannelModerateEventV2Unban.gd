...
static func create(user_id: String, user_login: String, user_name: String) -> TChannelModerateEventV2Unban:
	var _new = TChannelModerateEventV2Unban.new()
...
static func from_object(obj: Variant) -> TChannelModerateEventV2Unban:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelModerateEventV2Unban]: Object is not Dictionary: ", obj)
		return
