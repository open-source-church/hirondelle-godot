...
static func create(broadcaster_user_id: String) -> TChannelPollProgressCondition:
	var _new = TChannelPollProgressCondition.new()
	_new.broadcaster_user_id = broadcaster_user_id
	return _new

## Create from object (usually returned from api)
static func from_object(obj: Variant) -> TChannelPollProgressCondition:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelPollProgressCondition]: Object is not Dictionary: ", obj)
		return
