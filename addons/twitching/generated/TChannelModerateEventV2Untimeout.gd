...
static func create(user_id: String, user_login: String, user_name: String) -> TChannelModerateEventV2Untimeout:
	var _new = TChannelModerateEventV2Untimeout.new()
...
static func from_object(obj: Variant) -> TChannelModerateEventV2Untimeout:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelModerateEventV2Untimeout]: Object is not Dictionary: ", obj)
		return
