...
static func create(value: int, decimal_places: int, currency: String) -> TCharityCampaignStopEventTargetAmount:
	var _new = TCharityCampaignStopEventTargetAmount.new()
	_new.value = value
...
static func from_object(obj: Variant) -> TCharityCampaignStopEventTargetAmount:
	if not obj: return
	if not obj is Dictionary:
		print("[TCharityCampaignStopEventTargetAmount]: Object is not Dictionary: ", obj)
		return
