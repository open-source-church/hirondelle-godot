...
static func create(broadcaster_user_id: String) -> TChannelSubscriptionEndCondition:
	var _new = TChannelSubscriptionEndCondition.new()
	_new.broadcaster_user_id = broadcaster_user_id
	return _new

## Create from object (usually returned from api)
static func from_object(obj: Variant) -> TChannelSubscriptionEndCondition:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelSubscriptionEndCondition]: Object is not Dictionary: ", obj)
		return
