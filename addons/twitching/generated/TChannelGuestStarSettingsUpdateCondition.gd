...
static func create(broadcaster_user_id: String, moderator_user_id: String) -> TChannelGuestStarSettingsUpdateCondition:
	var _new = TChannelGuestStarSettingsUpdateCondition.new()
	_new.broadcaster_user_id = broadcaster_user_id
	_new.moderator_user_id = moderator_user_id
	return _new

## Create from object (usually returned from api)
static func from_object(obj: Variant) -> TChannelGuestStarSettingsUpdateCondition:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelGuestStarSettingsUpdateCondition]: Object is not Dictionary: ", obj)
		return
