...
static func create(broadcaster_user_id: String) -> TChannelSubscriptionGiftCondition:
	var _new = TChannelSubscriptionGiftCondition.new()
	_new.broadcaster_user_id = broadcaster_user_id
	return _new

## Create from object (usually returned from api)
static func from_object(obj: Variant) -> TChannelSubscriptionGiftCondition:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelSubscriptionGiftCondition]: Object is not Dictionary: ", obj)
		return
