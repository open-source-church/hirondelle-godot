...
static func create(value: int, decimal_places: int, currency: String) -> TCharityCampaignProgressEventTargetAmount:
	var _new = TCharityCampaignProgressEventTargetAmount.new()
	_new.value = value
...
static func from_object(obj: Variant) -> TCharityCampaignProgressEventTargetAmount:
	if not obj: return
	if not obj is Dictionary:
		print("[TCharityCampaignProgressEventTargetAmount]: Object is not Dictionary: ", obj)
		return
