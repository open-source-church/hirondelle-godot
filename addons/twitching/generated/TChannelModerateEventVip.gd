...
static func create(user_id: String, user_login: String, user_name: String) -> TChannelModerateEventVip:
	var _new = TChannelModerateEventVip.new()
...
static func from_object(obj: Variant) -> TChannelModerateEventVip:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelModerateEventVip]: Object is not Dictionary: ", obj)
		return
