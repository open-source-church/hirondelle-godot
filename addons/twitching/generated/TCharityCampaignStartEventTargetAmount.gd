...
static func create(value: int, decimal_places: int, currency: String) -> TCharityCampaignStartEventTargetAmount:
	var _new = TCharityCampaignStartEventTargetAmount.new()
	_new.value = value
...
static func from_object(obj: Variant) -> TCharityCampaignStartEventTargetAmount:
	if not obj: return
	if not obj is Dictionary:
		print("[TCharityCampaignStartEventTargetAmount]: Object is not Dictionary: ", obj)
		return
