...
static func create(user_id: String, user_login: String, user_name: String, broadcaster_user_id: String, broadcaster_user_login: String, broadcaster_user_name: String) -> TChannelVipRemoveEvent:
	var _new = TChannelVipRemoveEvent.new()
...
static func from_object(obj: Variant) -> TChannelVipRemoveEvent:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelVipRemoveEvent]: Object is not Dictionary: ", obj)
		return
