...
static func create(id: String, broadcaster_user_id: String, broadcaster_user_login: String, broadcaster_user_name: String, title: String, outcomes: TOutcomes, started_at: String, locked_at: String) -> TChannelPredictionLockEvent:
	var _new = TChannelPredictionLockEvent.new()
	_new.id = id
	...
	_new.locked_at = locked_at
	return _new

## Create from object (usually returned from api)
static func from_object(obj: Variant) -> TChannelPredictionLockEvent:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelPredictionLockEvent]: Object is not Dictionary: ", obj)
		return
	...
	_new.locked_at = obj.get("locked_at") if obj.get("locked_at") else ""
