...
static func create(id: String, emote_set_id: String, owner_id: String, format: Array[String]) -> TChannelChatNotificationEventEmote:
	var _new = TChannelChatNotificationEventEmote.new()
	_new.id = id
...
static func from_object(obj: Variant) -> TChannelChatNotificationEventEmote:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelChatNotificationEventEmote]: Object is not Dictionary: ", obj)
		return
