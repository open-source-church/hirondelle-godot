...
static func create(broadcaster_user_id: String, broadcaster_user_login: String, broadcaster_user_name: String, source_broadcaster_user_id: String, source_broadcaster_user_login: String, source_broadcaster_user_name: String, moderator_user_id: String, moderator_user_login: String, moderator_user_name: String, action: String, followers: TChannelModerateEventFollowers, slow: TChannelModerateEventSlow, vip: TChannelModerateEventVip, unvip: TChannelModerateEventUnvip, mod: TChannelModerateEventMod, unmod: TChannelModerateEventUnmod, ban: TChannelModerateEventBan, unban: TChannelModerateEventUnban, timeout: TChannelModerateEventTimeout, untimeout: TChannelModerateEventUntimeout, raid: TChannelModerateEventRaid, unraid: TChannelModerateEventUnraid, delete: TChannelModerateEventDelete, automod_terms: TChannelModerateEventAutomodTerms, unban_request: TChannelModerateEventUnbanRequest, shared_chat_ban: Variant, shared_chat_unban: Variant, shared_chat_timeout: Variant, shared_chat_untimeout: Variant, shared_chat_delete: Variant) -> TChannelModerateEvent:
	var _new = TChannelModerateEvent.new()
...
static func from_object(obj: Variant) -> TChannelModerateEvent:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelModerateEvent]: Object is not Dictionary: ", obj)
		return
	...
	_new.followers = TChannelModerateEventFollowers.from_object(obj.get("followers", {}))
	_new.slow = TChannelModerateEventSlow.from_object(obj.get("slow", {}))
	_new.vip = TChannelModerateEventVip.from_object(obj.get("vip", {}))
	_new.unvip = TChannelModerateEventUnvip.from_object(obj.get("unvip", {}))
	_new.mod = TChannelModerateEventMod.from_object(obj.get("mod", {}))
	_new.unmod = TChannelModerateEventUnmod.from_object(obj.get("unmod", {}))
	_new.ban = TChannelModerateEventBan.from_object(obj.get("ban", {}))
	_new.unban = TChannelModerateEventUnban.from_object(obj.get("unban", {}))
	_new.timeout = TChannelModerateEventTimeout.from_object(obj.get("timeout", {}))
	_new.untimeout = TChannelModerateEventUntimeout.from_object(obj.get("untimeout", {}))
	_new.raid = TChannelModerateEventRaid.from_object(obj.get("raid", {}))
	_new.unraid = TChannelModerateEventUnraid.from_object(obj.get("unraid", {}))
	_new.delete = TChannelModerateEventDelete.from_object(obj.get("delete", {}))
	_new.automod_terms = TChannelModerateEventAutomodTerms.from_object(obj.get("automod_terms", {}))
	_new.unban_request = TChannelModerateEventUnbanRequest.from_object(obj.get("unban_request", {}))
