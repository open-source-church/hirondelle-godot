...
static func create(user_id: String, user_login: String, user_name: String) -> TChannelModerateEventMod:
	var _new = TChannelModerateEventMod.new()
...
static func from_object(obj: Variant) -> TChannelModerateEventMod:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelModerateEventMod]: Object is not Dictionary: ", obj)
		return
