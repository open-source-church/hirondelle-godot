...
static func create(broadcaster_user_id: String, broadcaster_user_login: String, broadcaster_user_name: String, user_id: String, user_login: String, user_name: String) -> TChannelModeratorRemoveEvent:
	var _new = TChannelModeratorRemoveEvent.new()
...
static func from_object(obj: Variant) -> TChannelModeratorRemoveEvent:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelModeratorRemoveEvent]: Object is not Dictionary: ", obj)
		return
