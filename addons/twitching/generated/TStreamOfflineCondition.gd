...
static func create(broadcaster_user_id: String) -> TStreamOfflineCondition:
	var _new = TStreamOfflineCondition.new()
	_new.broadcaster_user_id = broadcaster_user_id
	return _new

## Create from object (usually returned from api)
static func from_object(obj: Variant) -> TStreamOfflineCondition:
	if not obj: return
	if not obj is Dictionary:
		print("[TStreamOfflineCondition]: Object is not Dictionary: ", obj)
		return
