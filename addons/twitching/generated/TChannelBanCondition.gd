...
static func create(broadcaster_user_id: String) -> TChannelBanCondition:
	var _new = TChannelBanCondition.new()
	_new.broadcaster_user_id = broadcaster_user_id
	return _new

## Create from object (usually returned from api)
static func from_object(obj: Variant) -> TChannelBanCondition:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelBanCondition]: Object is not Dictionary: ", obj)
		return
