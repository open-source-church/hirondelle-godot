...
var participants: TChannelSharedChatSessionUpdateEventParticipants

## Create is similar to _init but takes parameters. Useful for using with autocomplete in the editor.
static func create(session_id: String, broadcaster_user_id: String, broadcaster_user_name: String, broadcaster_user_login: String, host_broadcaster_user_id: String, host_broadcaster_user_name: String, host_broadcaster_user_login: String, participants: TChannelSharedChatSessionUpdateEventParticipants) -> TChannelSharedChatSessionUpdateEvent:
	var _new = TChannelSharedChatSessionUpdateEvent.new()
...
static func from_object(obj: Variant) -> TChannelSharedChatSessionUpdateEvent:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelSharedChatSessionUpdateEvent]: Object is not Dictionary: ", obj)
		return
	...
	_new.participants = TChannelSharedChatSessionUpdateEventParticipants.from_object(obj.get("participants", {}))
