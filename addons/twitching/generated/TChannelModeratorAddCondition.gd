...
static func create(broadcaster_user_id: String) -> TChannelModeratorAddCondition:
	var _new = TChannelModeratorAddCondition.new()
	_new.broadcaster_user_id = broadcaster_user_id
	return _new

## Create from object (usually returned from api)
static func from_object(obj: Variant) -> TChannelModeratorAddCondition:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelModeratorAddCondition]: Object is not Dictionary: ", obj)
		return
