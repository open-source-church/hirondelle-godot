...
static func create(value: int, decimal_places: int, currency: String) -> TCharityDonationEventAmount:
	var _new = TCharityDonationEventAmount.new()
	_new.value = value
...
static func from_object(obj: Variant) -> TCharityDonationEventAmount:
	if not obj: return
	if not obj is Dictionary:
		print("[TCharityDonationEventAmount]: Object is not Dictionary: ", obj)
		return
