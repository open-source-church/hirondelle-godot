...
static func create(user_id: String, user_login: String, user_name: String, viewer_count: int) -> TChannelModerateEventRaid:
	var _new = TChannelModerateEventRaid.new()
...
static func from_object(obj: Variant) -> TChannelModerateEventRaid:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelModerateEventRaid]: Object is not Dictionary: ", obj)
		return
