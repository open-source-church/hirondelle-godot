...
static func create(set_id: String, id: String, info: String) -> TChannelChatMessageEventSourceBadges:
	var _new = TChannelChatMessageEventSourceBadges.new()
	_new.set_id = set_id
	_new.id = id
	_new.info = info
	return _new
...
static func from_object(obj: Variant) -> TChannelChatMessageEventSourceBadges:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelChatMessageEventSourceBadges]: Object is not Dictionary: ", obj)
		return
