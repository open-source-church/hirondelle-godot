...
static func create(user_id: String, user_login: String, user_name: String, broadcaster_user_id: String, broadcaster_user_login: String, broadcaster_user_name: String, tier: String, is_gift: bool) -> TChannelSubscribeEvent:
	var _new = TChannelSubscribeEvent.new()
...
static func from_object(obj: Variant) -> TChannelSubscribeEvent:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelSubscribeEvent]: Object is not Dictionary: ", obj)
		return
