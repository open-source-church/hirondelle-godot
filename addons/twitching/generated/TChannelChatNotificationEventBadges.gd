...
static func create(set_id: String, id: String, info: String) -> TChannelChatNotificationEventBadges:
	var _new = TChannelChatNotificationEventBadges.new()
	_new.set_id = set_id
	_new.id = id
	_new.info = info
	return _new
...
static func from_object(obj: Variant) -> TChannelChatNotificationEventBadges:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelChatNotificationEventBadges]: Object is not Dictionary: ", obj)
		return
