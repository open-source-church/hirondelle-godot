...
static func from_object(obj: Variant) -> TChannelPointsCustomRewardAddEvent:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelPointsCustomRewardAddEvent]: Object is not Dictionary: ", obj)
		return
