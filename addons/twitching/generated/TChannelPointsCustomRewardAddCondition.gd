...
static func create(broadcaster_user_id: String) -> TChannelPointsCustomRewardAddCondition:
	var _new = TChannelPointsCustomRewardAddCondition.new()
	_new.broadcaster_user_id = broadcaster_user_id
	return _new

## Create from object (usually returned from api)
static func from_object(obj: Variant) -> TChannelPointsCustomRewardAddCondition:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelPointsCustomRewardAddCondition]: Object is not Dictionary: ", obj)
		return
