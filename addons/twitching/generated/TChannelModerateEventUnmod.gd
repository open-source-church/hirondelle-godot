...
static func create(user_id: String, user_login: String, user_name: String) -> TChannelModerateEventUnmod:
	var _new = TChannelModerateEventUnmod.new()
...
static func from_object(obj: Variant) -> TChannelModerateEventUnmod:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelModerateEventUnmod]: Object is not Dictionary: ", obj)
		return
