...
static func create(user_id: String, user_login: String, user_name: String) -> TChannelModerateEventV2Mod:
	var _new = TChannelModerateEventV2Mod.new()
...
static func from_object(obj: Variant) -> TChannelModerateEventV2Mod:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelModerateEventV2Mod]: Object is not Dictionary: ", obj)
		return
