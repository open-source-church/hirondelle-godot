...
static func create(broadcaster_user_id: String) -> TChannelPredictionProgressCondition:
	var _new = TChannelPredictionProgressCondition.new()
	_new.broadcaster_user_id = broadcaster_user_id
	return _new

## Create from object (usually returned from api)
static func from_object(obj: Variant) -> TChannelPredictionProgressCondition:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelPredictionProgressCondition]: Object is not Dictionary: ", obj)
		return
