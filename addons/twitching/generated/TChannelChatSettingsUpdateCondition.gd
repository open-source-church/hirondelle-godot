...
static func create(broadcaster_user_id: String, user_id: String) -> TChannelChatSettingsUpdateCondition:
	var _new = TChannelChatSettingsUpdateCondition.new()
	_new.broadcaster_user_id = broadcaster_user_id
	_new.user_id = user_id
	return _new

## Create from object (usually returned from api)
static func from_object(obj: Variant) -> TChannelChatSettingsUpdateCondition:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelChatSettingsUpdateCondition]: Object is not Dictionary: ", obj)
		return
