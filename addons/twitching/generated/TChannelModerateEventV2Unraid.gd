...
static func create(user_id: String, user_login: String, user_name: String) -> TChannelModerateEventV2Unraid:
	var _new = TChannelModerateEventV2Unraid.new()
...
static func from_object(obj: Variant) -> TChannelModerateEventV2Unraid:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelModerateEventV2Unraid]: Object is not Dictionary: ", obj)
		return
