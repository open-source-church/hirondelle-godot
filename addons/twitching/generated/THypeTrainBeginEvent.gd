...
static func create(id: String, broadcaster_user_id: String, broadcaster_user_login: String, broadcaster_user_name: String, total: int, progress: int, goal: int, top_contributions: TTopContributions, last_contribution: TLastContribution, level: int, started_at: String, expires_at: String, is_golden_kappa_train: bool) -> THypeTrainBeginEvent:
	var _new = THypeTrainBeginEvent.new()
	_new.id = id
...
static func from_object(obj: Variant) -> THypeTrainBeginEvent:
	if not obj: return
	if not obj is Dictionary:
		print("[THypeTrainBeginEvent]: Object is not Dictionary: ", obj)
		return
