...
static func create(value: int, decimal_places: int, currency: String) -> TCharityCampaignStopEventCurrentAmount:
	var _new = TCharityCampaignStopEventCurrentAmount.new()
	_new.value = value
...
static func from_object(obj: Variant) -> TCharityCampaignStopEventCurrentAmount:
	if not obj: return
	if not obj is Dictionary:
		print("[TCharityCampaignStopEventCurrentAmount]: Object is not Dictionary: ", obj)
		return
