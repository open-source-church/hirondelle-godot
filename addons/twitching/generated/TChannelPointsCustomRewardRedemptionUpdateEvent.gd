...
static func create(id: String, broadcaster_user_id: String, broadcaster_user_login: String, broadcaster_user_name: String, user_id: String, user_login: String, user_name: String, user_input: String, status: String, reward: TReward, redeemed_at: String) -> TChannelPointsCustomRewardRedemptionUpdateEvent:
	var _new = TChannelPointsCustomRewardRedemptionUpdateEvent.new()
	_new.id = id
...
static func from_object(obj: Variant) -> TChannelPointsCustomRewardRedemptionUpdateEvent:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelPointsCustomRewardRedemptionUpdateEvent]: Object is not Dictionary: ", obj)
		return
