...
static func create(broadcaster_user_id: String) -> TCharityCampaignStartCondition:
	var _new = TCharityCampaignStartCondition.new()
	_new.broadcaster_user_id = broadcaster_user_id
	return _new

## Create from object (usually returned from api)
static func from_object(obj: Variant) -> TCharityCampaignStartCondition:
	if not obj: return
	if not obj is Dictionary:
		print("[TCharityCampaignStartCondition]: Object is not Dictionary: ", obj)
		return
