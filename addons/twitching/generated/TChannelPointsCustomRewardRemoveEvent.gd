...
static func from_object(obj: Variant) -> TChannelPointsCustomRewardRemoveEvent:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelPointsCustomRewardRemoveEvent]: Object is not Dictionary: ", obj)
		return
