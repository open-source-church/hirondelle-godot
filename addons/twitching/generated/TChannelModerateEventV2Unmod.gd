...
static func create(user_id: String, user_login: String, user_name: String) -> TChannelModerateEventV2Unmod:
	var _new = TChannelModerateEventV2Unmod.new()
...
static func from_object(obj: Variant) -> TChannelModerateEventV2Unmod:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelModerateEventV2Unmod]: Object is not Dictionary: ", obj)
		return
