...
static func create(user_id: String, user_login: String, user_name: String) -> TChannelModerateEventV2Vip:
	var _new = TChannelModerateEventV2Vip.new()
...
static func from_object(obj: Variant) -> TChannelModerateEventV2Vip:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelModerateEventV2Vip]: Object is not Dictionary: ", obj)
		return
