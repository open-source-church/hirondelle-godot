...
static func create(set_id: String, id: String, info: String) -> TChannelChatNotificationEventSourceBadges:
	var _new = TChannelChatNotificationEventSourceBadges.new()
	_new.set_id = set_id
	_new.id = id
	_new.info = info
	return _new
...
static func from_object(obj: Variant) -> TChannelChatNotificationEventSourceBadges:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelChatNotificationEventSourceBadges]: Object is not Dictionary: ", obj)
		return
