...
static func create(broadcaster_user_id: String) -> TStreamOnlineCondition:
	var _new = TStreamOnlineCondition.new()
	_new.broadcaster_user_id = broadcaster_user_id
	return _new

## Create from object (usually returned from api)
static func from_object(obj: Variant) -> TStreamOnlineCondition:
	if not obj: return
	if not obj is Dictionary:
		print("[TStreamOnlineCondition]: Object is not Dictionary: ", obj)
		return
