...
static func create(user_id: String, user_login: String, user_name: String) -> TChannelModerateEventUnraid:
	var _new = TChannelModerateEventUnraid.new()
...
static func from_object(obj: Variant) -> TChannelModerateEventUnraid:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelModerateEventUnraid]: Object is not Dictionary: ", obj)
		return
