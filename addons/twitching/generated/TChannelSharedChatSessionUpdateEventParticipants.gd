...
static func create(broadcaster_user_id: String, broadcaster_user_name: String, broadcaster_user_login: String) -> TChannelSharedChatSessionUpdateEventParticipants:
	var _new = TChannelSharedChatSessionUpdateEventParticipants.new()
...
static func from_object(obj: Variant) -> TChannelSharedChatSessionUpdateEventParticipants:
	if not obj: return
	if not obj is Dictionary:
		print("[TChannelSharedChatSessionUpdateEventParticipants]: Object is not Dictionary: ", obj)
		return
